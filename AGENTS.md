...
- Do not use versions in @requirements.txt  
- use context7 MCP as needed FOR STREAMLIT DOCS
- Do not test with a browser unless the user explicitly instructs you to.